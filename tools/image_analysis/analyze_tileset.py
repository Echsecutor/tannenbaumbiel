...
This tool analyzes sprite sheets/tilesets to:
- Detect tile boundaries using edge detection and Hough transforms
- Identify winter-themed regions using color analysis
- Extract tiles automatically based on grid patterns
- Generate visualizations showing detected regions
...
Usage:
    ...
    python3 analyze_tileset.py <image_path>
"""
