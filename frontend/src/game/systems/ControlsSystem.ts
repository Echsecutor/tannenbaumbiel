...
export class ControlsSystem {
    ...
    private createTouchControls() {
        ...
        const leftArea = this.scene.add.rectangle(100, this.scene.scale.height - 100, 150, 150, 0x000000, 0.3)
        ...
        const rightArea = this.scene.add.rectangle(250, this.scene.scale.height - 100, 150, 150, 0x000000, 0.3)
        ...
        // Jump button
        const jumpArea = this.scene.add.rectangle(this.scene.scale.width - 150, this.scene.scale.height - 100, 150, 150, 0x000000, 0.3)
        ...
        // Shoot button
        const shootArea = this.scene.add.rectangle(this.scene.scale.width - 300, this.scene.scale.height - 100, 150, 150, 0x000000, 0.3)
        ...
        // Add control labels
        this.scene.add.text(100, this.scene.scale.height - 100, '←', { 
            fontSize: '32px', color: '#ffffff' 
        }).setOrigin(0.5).setScrollFactor(0)
        
        this.scene.add.text(250, this.scene.scale.height - 100, '→', { 
            fontSize: '32px', color: '#ffffff' 
        }).setOrigin(0.5).setScrollFactor(0)
        
        this.scene.add.text(this.scene.scale.width - 150, this.scene.scale.height - 100, '↑', { 
            fontSize: '32px', color: '#ffffff' 
        }).setOrigin(0.5).setScrollFactor(0)
        
        this.scene.add.text(this.scene.scale.width - 300, this.scene.scale.height - 100, '⚡', { 
            fontSize: '32px', color: '#ffffff' 
        }).setOrigin(0.5).setScrollFactor(0)
    }
    ...
    getCurrentInputs() {
        return {
            ...
            shoot: (this.scene.input.activePointer.isDown && !this.scene.input.activePointer.wasTouch) || 
    ...
    isShootPressed(): boolean {
        return (this.scene.input.activePointer.isDown && !this.scene.input.activePointer.wasTouch) || 
               this.wasd.SPACE.isDown || 
               this.mobileInput.shoot
    }
    ...
    hasActiveInput(): boolean {
        return this.cursors.left.isDown || this.cursors.right.isDown || 
               ...
               this.wasd.W.isDown || this.wasd.S.isDown || this.wasd.SPACE.isDown ||
               this.mobileInput.left || this.mobileInput.right || 
               this.mobileInput.jump || this.mobileInput.shoot
    }
