...
export class GameSceneRefactored extends Phaser.Scene {
    ...
    private initializeSystems() {
        ...
        this.gameStateManager = new GameStateManager(this, this.networkSystem, this.isOffline)
    }
    ...
    private createGameSystems(networkManager: NetworkManager) {
        // Create core game objects
        const enemies = this.enemySystem.createEnemyGroup()
        const projectiles = this.physicsSystem.createProjectileGroup()
        const platforms = this.worldGenerator.createWorld()
    ...
    private handleInput() {
        ...
        const inputDetected = this.playerSystem.handleMovement()
    ...
    private handleProjectilePlatformHit(projectile: any, platform: any) {
        projectile.destroy()
    }
